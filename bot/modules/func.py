...
async def edit_video_metadata(user_id, file_path):
    ...
    cmd = [
        ...
        '-metadata', f'license=© @SharkToonsIndia. No reuploading or copying. DMCA Protected. Any unauthorized distribution, reproduction, or modification is a violation of DMCA and copyright laws."',
        '-metadata', f'LICENSE=© @SharkToonsIndia. No reuploading or copying. DMCA Protected. Any unauthorized distribution, reproduction, or modification is a violation of DMCA and copyright laws."',
        ...
        '-metadata', f'comment=Encoded By -- SharkToonsIndia --',
        ...
        '-metadata', f'encoder=SharkToonsIndia',
        '-metadata', f'SUMMARY=This File Is Downloaded From "@SharkToonsIndia " so Please Join Our Channels and Support Us We Need Your Support  ~ SharkToonsIndia ',
        '-metadata', f'AUTHOR=SharkToonsIndia',
        ...
        '-metadata', f'COMMENT=This File Is Downloaded From "@SharkToonsIndia " so Please Join Our Channels and Support Us We Need Your Support  ~ SharkToonsIndia',
        '-metadata', f'ENCODER=SharkToonsIndia',
        '-metadata', f'FILENAME=',
        '-metadata', f'MIMETYPE=',
        '-metadata', f'PURL=',
